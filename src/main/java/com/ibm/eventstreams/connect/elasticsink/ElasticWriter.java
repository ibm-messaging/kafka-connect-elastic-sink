...
public class ElasticWriter {
  ...
  private int jettyOperationTimeoutSec = ElasticSinkConnector.DEFAULT_JETTY_OPERATION_TIMEOUT_SEC; // How long to allow for each PUT to complete. Should be less than MAX_COMMIT_TIME_SEC
  ...
  private void dumpConfig(Map<String, String> props) {
    String output = String.format("ElasticSinkConnector values:\n");
