...
public class ESWriter {
  ...
  public void send(SinkRecord record) throws ConnectException, RetriableException {
    ...
    // - A unique id is made from the index, kafka partition/offset and timestamp. That allows us
    ...
    String id   = index + "!" + record.kafkaPartition() + "!" + record.kafkaOffset() + "!" + record.timestamp();
