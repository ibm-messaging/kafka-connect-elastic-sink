...
import com.ibm.eventstreams.connect.essink.builders.IdentifierBuilder;
import com.ibm.eventstreams.connect.essink.builders.IndexBuilder;
...
public class ESWriter {
  ...
  public void configure(Map<String, String> props) throws ConnectException {
    ...
    String documentBuilderClass = props.get(ESSinkConnector.CONFIG_NAME_ES_DOCUMENT_BUILDER);
    String indexBuilderClass = props.get(ESSinkConnector.CONFIG_NAME_ES_INDEX_BUILDER);
    String identifierBuilderClass = props.get(ESSinkConnector.CONFIG_NAME_ES_IDENTIFIER_BUILDER);
  ...
  public void send(SinkRecord record) throws ConnectException, RetriableException {
    ...
    */
    ...
    // If the document is null, add it to the index
