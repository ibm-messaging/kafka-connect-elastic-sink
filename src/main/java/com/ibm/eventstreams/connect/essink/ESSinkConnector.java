...
public class ESSinkConnector extends SinkConnector {
  ...
  public ConfigDef config() {
    ...
    config.define(CONFIG_NAME_ES_IDENTIFIER_BUILDER, Type.STRING, ConfigDef.NO_DEFAULT_VALUE, Importance.MEDIUM, CONFIG_DOCUMENTATION_ES_IDENTIFIER_BUILDER,
        CONFIG_GROUP_ES, 22, Width.MEDIUM, CONFIG_DISPLAY_ES_IDENTIFIER_BUILDER);
